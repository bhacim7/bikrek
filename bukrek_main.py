...
YOLO_MODEL_PATH = "C:/Users/barış hacim/PycharmProjects/PythonProject/train87/weights/best.engine"  # Veya .onnx
...
class HavaSavunmaArayuz(QWidget):
    def __init__(self):
        ...
        self.aiming_tolerance = 15  # Daha hassas nişan alma için
        ...
        self.KP_YAW = 0.3  # 0.04'ten 0.06'ya yükseltildi
        self.KI_YAW = 0.0001  # 0.0001'den 0.0002'ye yükseltildi
        self.KD_YAW = 0.001  # 0.08'den 0.12'ye yükseltildiS

        self.KP_PITCH = 0.2  # 0.04'ten 0.06'ya yükselStildi
        self.KI_PITCH = 0.0001  # 0.0001'den 0.0002'ye yükseltildi
        self.KD_PITCH = 0.001  # 0.08'den 0.12'ye yüksSeltildi
        ...
        self.feedforward_velocity_threshold_px_s = 0.0
        ...
        self.MIN_OUTPUT_DEGREE_THRESHOLD = 0.03  # 0.03'ten 0.01'e düşürüldü, daha ince hareketlere izin vermek için
        ...
        self.pid_output_deadband_degree = 0.05  # 0.02'den 0.01'e düşürüldü, daha hassas kilitleme için
        ...
        self.angle_command_minimum_interval = 0.04  # Her 30ms'de bir komut göndermeye çalış
