...
# input_shape parametresi (batch, channels, height, width) olarak güncellendi
def build_engine(onnx_file_path, engine_file_path, input_shape=(1, 3, 608, 1056)):
    """
...
if __name__ == "__main__":
    ...
    ONNX_MODEL_PATH = "C:/Users/barış hacim/PycharmProjects/PythonProject/HSSmultipocess/v23m1056.onnx"
    ...
    # Giriş boyutu (batch, channels, height, width) sırasıyla 608x1056 için güncellendi.
    YOLO_INPUT_SHAPE = (1, 3, 608, 1056)
